...
//
//	@Test
//	public void testGetDashboardByStatus() throws JSONException {
//
//		HttpEntity<String> entity = new HttpEntity<String>(null, headers);
//
//		ResponseEntity<String> response = restTemplate.exchange(createURLWithPort("/vclaims/adminDashboard/open"), HttpMethod.GET,
//				entity, String.class);
//
