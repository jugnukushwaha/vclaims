...
public interface AdminDashboardDaoRepository extends JpaRepository<ClaimDetails, Integer> {
	...
	@Query(value="Select c.claim_id,c.policy_no,c.vtype,c.status,c.imgUrl, u.First_name , u.Last_name , u.Email, p.Vehicle_brand,p.Ins_Period,p.Vehicle_No,p.Ins_Start_Date From Claim_details as c"
